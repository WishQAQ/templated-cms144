...
$(document).ready(function()
{
	...
	*/
	...
	$("#email").change( function() {
		...
		{
			$('#_email').html("<font color='red'>×邮箱格式错误</font>");
			$('#email').focus();
		}else{
			$.ajax({type: reMethod,url: "index_do.php",
	...
	$('#txtPassword').change( function(){
		...
		{
			$('#_userpwdok').html("<font color='red'>×不能小于"+pwdmin+"位</font>");
		}
		else if($('#userpwdok').val()!=$('txtPassword').val())
		{
			$('#_userpwdok').html("<font color='red'>×密码输入不一致</font>");
		}
		...
		{
			$('#_userpwdok').html("<font color='#3D882D'>√密码填写正确</font>");
		}
	});
	...
	$('#userpwdok').change( function(){
		...
		{
			$('#_userpwdok').html("<font color='#4E7504'>√密码填写正确</font>");
		}
	});
