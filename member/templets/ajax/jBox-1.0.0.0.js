...
var jBox={
	...
	init:function(id){
		...
		var box = $('<div class="jBox" id="'+id+'"></div' ).appendTo(holder);
			box.append('<div class="jBoxHandler">jBox<div class="jBoxControls"><button id="btn_close" title="¹Ø±Õ"></button></div></div>')
    ...
    setupControls:function(e){
	    ...
	    else if (/¹Ø±Õ/i.test(sourceobj.getAttribute("title")))
		   j.close(box);
	    return false;
	},
	showModel:function(){
