...
else if($dopost=="addArc")
{
    if($channelid==1)
    {
        $addcon = 'fx_cy.php?channelid='.$channelid;
    }
    else if($channelid==2)
    {
...
else if($dopost=="edit")
{
    ...
    if($channelid==1)
    {
        $edit = 'fx_cy_edit.php?channelid='.$channelid;
    }
    else if($channelid==2)
    {
...
else if($dopost=="delArc")
{
    ...
    $ENV_GOBACK_URL = empty($_COOKIE['ENV_GOBACK_URL']) ? 'gl_cy.php?channelid=' : $_COOKIE['ENV_GOBACK_URL'];
    ...
    if($ENV_GOBACK_URL=='gl_cy.php?channelid=')
    {
