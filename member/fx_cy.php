...
if(empty($dopost))
{
    ...
    include(DEDEMEMBER."/templets/fx_cy@@.htm");
    exit();
}
/*------------------------------
...
'$color','$writer','$source','$litpic','$pubdate','$senddate','$mid','$description','$keywords','$mtypesid'); ";
    ...
    $msg =
    "请选择你的后续操作：
    <a href='fx_cy.php?cid=$typeid'><u>继续发布文章</u></a>
    &nbsp;&nbsp;
    <a href='$artUrl' target='_blank'><u>查看文章</u></a>
    &nbsp;&nbsp;
    <a href='fx_cy_edit.php?channelid=$channelid&aid=$arcID'><u>更改文章</u></a>
    &nbsp;&nbsp;
    <a href='gl_cy.php?channelid={$channelid}'><u>已发布文章管理</u></a>";
    $wintitle = "成功发布文章！";
    $wecome_info = "成功发布文章！";
    $win = new OxWindow();
    //$win->AddTitle("成功发布文章：");
