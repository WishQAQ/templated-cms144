...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFF9AA">
  <tr>
    <td height="28" style="border:1px solid #DADADA" background='/plus/img/wbg.gif'>&nbsp;<b>◇畅言评论插件 》</b></td>
  </tr>
  <tr>
          ...
          <tbody>
            <tr>
              ...
              <td width="84%" style="text-align:left;"><input name="user" type="text" id="user" size="16" style="width:200px" value="{$user}" />
                <a href="?dopost=reg" style="color:blue">没有账号？去注册……</a></td>
            </tr>
            <tr>
              <td height="30">密码：</td>
              <td style="text-align:left;"><input name="pwd" type="password" id="pwd" size="16" style="width:200px">
...
<table width="98%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    ...
    <tr>
      <td width="16%" height="30">App  ID：</td>
      <td width="84%" style="text-align:left;"><input class="input-xlarge" type="text" value="{$client_id}" disabled="disabled/" style="width:260px"> <a href='?dopost=change_appinfo' style='color:blue'>[修改]</a> </td>
    </tr>
    <tr>
      <td width="16%" height="30">APP Key：</td>
      <td width="84%" style="text-align:left;"><input class="input-xlarge" type="text" value="{$isv_app_key}" disabled="disabled/" style="width:260px"> <a href='?dopost=change_appinfo' style='color:blue'>[修改]</a> </td>
    </tr>
    <tr>
